...
**[🌐 Landing page](https://ljojua1998.github.io/skills/)** · **[📖 Usage guide](GUIDE.md)** · [Quick start](#-quick-start) · [How it works](#-how-it-works) · [Commands](#-commands) · [The crew](#-the-crew) · [Guarantees](#-hard-guarantees) · [Token efficiency](#-token-efficiency)
